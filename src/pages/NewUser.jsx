    ...
    return (
        <div className="container mx-auto px-6 lg:px-8 py-10 max-w-6xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
                {/* SINISTRA: Indicazioni */}
                <aside className="h-full">
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm h-full flex flex-col overflow-hidden">
                        {/* Immagine */}
                        <img
                            src="https://i.imgur.com/F36zWYx.jpeg"
                            ...
                            <div className="flex items-start gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm opacity-80 mt-1">
                                        L'iscrizione è riservata agli operatori del sistema regionale
                                        di protezione civile.
                                    </p>
                                </div>
                            </div>

                            <section className="space-y-3 text-sm leading-relaxed flex-1">
                                <p className="font-semibold">Informazioni</p>
                                <ul className="space-y-2">
                                    <li>
                                        <strong>Dipendenti pubblici:</strong>{" "}
                                        <u>NON UTILIZZARE PEC</u>. Usare solo mail istituzionali
                                        dell’Ente (es.{" "}
                                        <span className="font-mono">
                                            mario.rossi@comunexxx.it
                                        </span>
                                        ,{" "}
                                        <span className="font-mono">
                                            tecnico@comunexxx.it
                                        </span>
                                        ).
                                    </li>
                                    <li>
                                        <strong>Volontari:</strong> Ammesse mail personali o
                                        dell’associazione. L’abilitazione verrà convalidata dopo la
                                        conferma del Presidente/Coordinatore. Il
                                        Presidente/Coordinatore può confermare alla mail:{" "}
                                        <a
                                ...
                                <p className="opacity-80">
                                    La stessa mail non può essere utilizzata da più utenti. Tutti i
                ...
                {/* DESTRA: Form */}
                <main className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 shadow-sm overflow-hidden h-full flex flex-col">
                    {/* Header card form */}
                    <div className="px-6 py-5 border-b border-slate-200/70 dark:border-slate-800/70 bg-gradient-to-r from-slate-50 to-white dark:from-slate-900 dark:to-slate-900/40">
                        <h2 className="text-lg font-semibold">Richiesta di abilitazione</h2>
                    ...
                    {done && (
                        <div className="px-6 pt-6">
                            <div className="rounded-xl border border-emerald-300/60 dark:border-emerald-700/60 bg-emerald-50 dark:bg-emerald-900/30 p-4 text-sm">
                                Richiesta inviata. L’abilitazione verrà convalidata secondo le
                                procedure indicate.
                            </div>
                        </div>
                    )}
                        ...
                        <form onSubmit={onSubmit} className="space-y-6">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div className="group">
                                    ...
                                    {errors.cognome && (
                                        <p className="text-xs text-red-600 mt-1">{errors.cognome}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="group">
                                ...
                                {errors.ente && (
                                    <p className="text-xs text-red-600 mt-1">{errors.ente}</p>
                                )}
                            </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div className="group">
                                    ...
                                    {errors.conferma && (
                                        <p className="text-xs text-red-600 mt-1">{errors.conferma}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="pt-2">
                                ...
                                <p className="text-xs opacity-70 mt-3 text-center">
                                    Inviando la richiesta dichiari di aver letto e compreso le
